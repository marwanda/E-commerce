...
<!--                </div>-->
                ...
                <form id="register-form-user" action="requests/register.php"  method="post" class="form-horizontal  col-8 " >
                    ...
                    <div class="form-group">
                        <label class="col-md-8 control-label align-elements "><?php echo $lang['password'] ?>:</label>
                        <div class="col-md-8">
                    ...
                    <div class="form-group">
                        <label class="col-md-8 control-label align-elements "><?php echo $lang['re_password'] ?>:</label>
                        <div class="col-md-8">
