          ...
          <div class="col-md-8">
            <div class="single-news-p1-cont">
              ...
              <div class="single-news-desc ">
                ...
                <ul class="list-inline primary-color mt-5">
                    <li><span class="mr-2"><i class="fa fa-calendar" aria-hidden="true"></i> 10/10/2019</span></li>
...
<!--            <div class="ad-box-sn"> -->
<!--              <h3 class="pb-2">Latest Products</h3>-->
<!--                --><?php
...
//                for ($i=0;$i<3;$i++)
//                {
//                    template('cards/product-news.php', array());
//                }
//                ?>
<!--            </div>-->
          </div>
