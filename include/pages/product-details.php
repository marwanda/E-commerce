        ...
        <div class="wrapper row">
            <div class="preview col-md-6">
                ...
                <div class="preview-pic tab-content">
                    <div class="tab-pane active" id="pic-1"><img class="product-details-large-pic"
                    ...
                    <!--                  <div class="tab-pane" id="pic-2"><img src="-->
                    <?php //echo $APP_ROOT ?><!--assets/img/shop/shop-item-3.jpg" /></div>-->
                    <!--                  <div class="tab-pane" id="pic-3"><img src="-->
                    <?php //echo $APP_ROOT ?><!--assets/img/shop/shop-item-4.jpg" /></div>-->
                    <!--                  <div class="tab-pane" id="pic-4"><img src="-->
                    <?php //echo $APP_ROOT ?><!--assets/img/shop/shop-item-5.jpg" /></div>-->
                    <!--                  <div class="tab-pane" id="pic-5"><img src="-->
                    <?php //echo $APP_ROOT ?><!--assets/img/shop/shop-item-2.jpg" /></div>-->
                </div>
                <ul class="preview-thumbnail nav nav-tabs">
                    <li class="active"><a class="product-gallery-thumbs" data-target="#pic-1" data-toggle="tab"><img
                                    src="<?php echo $FILES_ROOT . 'images/products/large/' . $pic ?>"/></a></li>
                    <?php
                    $i = 2;
                    if (isset($arr2)) {
                        foreach ($arr2 as $pic) {
                    ...
                    ?>
                    <!--                  <li class="active"><a data-target="#pic-1" data-toggle="tab"><img src="-->
                    <?php //echo $FILES_ROOT.'images/products/thumb/'.$pic?><!--" /></a></li>-->
                    <!--                  <li><a data-target="#pic-2" data-toggle="tab"><img src="-->
                    <?php //echo $APP_ROOT ?><!--assets/img/shop/shop-item-3.jpg" /></a></li>-->
                    <!--                  <li><a data-target="#pic-3" data-toggle="tab"><img src="-->
                    <?php //echo $APP_ROOT ?><!--assets/img/shop/shop-item-4.jpg" /></a></li>-->
                    <!--                  <li><a data-target="#pic-4" data-toggle="tab"><img src="-->
                    <?php //echo $APP_ROOT ?><!--assets/img/shop/shop-item-5.jpg" /></a></li>-->
                    <!--                  <li><a data-target="#pic-5" data-toggle="tab"><img src="-->
                    <?php //echo $APP_ROOT ?><!--assets/img/shop/shop-item-2.jpg" /></a></li>-->
                </ul>
            </div>
            <div class="details col-md-6">
                ...
                <h6 class="price mb-5"><?php echo $lang['current_price'] ?>
                    <span><?php echo $_SESSION['role'] == 3 ? $price_vip . ' ' . $lang['sp'] : $price . ' ' . $lang['sp'] ?></span>
                </h6>
                    ...
                    <div class="action " style="margin-top: 116px">
                        <div class="title-but">
                            <button data-id="<?php echo $id ?>"
                                    class="btn btn-general product-details-add-button btn-white <?php if (isset($_SESSION['role']) && (($_SESSION['role'] == 2 || $_SESSION['role'] == 3))) {
                                        echo 'add-to-cart';
                                    } else {
                                        echo 'add-to-cart-login';
                                    } ?>" role="button"><i
                                        class="fa fa-cart-plus"></i> <?php echo $lang['add_to_cart'] ?></button>
                        </div>
                    </div>
            ...
            <div class="service-h-tab">
                <nav class="nav nav-tabs" id="myTab" role="tablist">
                    <a class="nav-item nav-link active" id="nav-profile-tab" data-toggle="tab" href="#nav-profile"
                       role="tab" aria-controls="nav-profile"><?php echo $lang['description'] ?></a>
                </nav>
