...
<div class="content-inner chart-cont">
    ...
    <div class="row ">
        <h2 class="mb-5">News Listing</h2>
        <table style="width: 100% " id="datatable" class="table table-hover mt-5 table-striped">
            <thead>
            <tr class="bg-info text-white">
                <th class="">#</th>
                <th class="table-width-5">Title</th>
                <th class="table-width-5">Thumbnail</th>
                <th class="table-width-5">By</th>
                <th class="table-width-5">Date</th>
                <th class="table-width-5" style="">Actions</th>
            </tr>
            </thead>
            <tbody>
            <tr class="table-primary">
                <td class="">136</td>
                <td class="table-width-5">D-Link new features</td>
                <td class="table-width-5"><img></td>
                <td class="table-width-5">Mhd Salem</td>
                <td class="table-width-5">12/8/2019 2:07 PM</td>
                <td class="table-width-5">
                    <button class="btn btn-danger btn edit-news"><i class="fa fa-pencil-square-o  " aria-hidden="true"></i></button>
                    <button class="btn btn-danger btn delete-news">  <i class="fa fa-trash-o  " aria-hidden="true"></i></button></td>
            </tr>
