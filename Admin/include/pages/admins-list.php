    ...
    <div class="modal-dialog">
        ...
        <div align="center" class="modal-content" style="margin-top: 100px">
            ...
            <div class="modal-footer">
                <div class="row">
                    <div class="col"><button id="yes-status-admin" type="button" class="btn btn-info btn" data-dismiss="modal">Yes</button></div>
                    <div class="col"><button id="no-status-admin" type="button" class="btn btn-info btn" data-dismiss="modal">No</button></div>
                </div>
                ...
                <td class="text-left">
                    <div class="btn-group btn-group-toggle" data-toggle="buttons">
                        <label class="btn btn-info active ">
                            <input checked  type="radio" name="options" class="active-admin" autocomplete="off" > Active
                        </label>
                        <label class="btn btn-info btn">
                            <input type="radio" name="options" class="inactive-admin" autocomplete="off"> Blocked
                        </label>
                    </div>
                </td>
            </tr>
