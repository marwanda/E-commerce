    ...
    <div class="modal-dialog">
        ...
        <div align="center" class="modal-content" style="margin-top: 100px">
            ...
            <div class="modal-footer">
                <div class="row">
                    <div class="col"><button id="yes-member-delete" type="button" class="btn btn-info btn" data-dismiss="modal">Yes</button></div>
                    <div class="col"><button id="no-member-delete" type="button" class="btn btn-info btn" data-dismiss="modal">No</button></div>
                </div>
    ...
    <div class="row ">
        <div class="col">
            <div class="row">
                ...
                <div class="col-8"><button id="add-member" class="btn btn-info btn  ">Add</i></button>
                </div>
            </div>
