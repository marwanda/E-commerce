  ...
  show active  <?php } ?>" id="nav-profile" role="tabpanel"
                            ...
                            <form id="" action="requests/edit-admin-profile.php" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <button type="submit" id="edit-admin-profile"  class="btn btn-general btn-blue mr-2">Submit</button>
                                        <span></span>
                                    </div>
                                </div>
                            </form>
...
<?php } ?> " id="nav-password" role="tabpanel"
                            ...
                            <form id="change-password-form" action="requests/change-password.php" method="post" class="mt-5 form-horizontal  col-8 "
                                  role="form">
                                ...
                                <div class="form-group">
                                    <label class="col-md-8 control-label text-left "></label>
                                    <div class="col-md-8">
                                        <button type="submit" id="submit-change-password"  class="btn btn-general btn-blue mr-2">Submit</button>
                                        <span></span>
                                    </div>
                                </div>
                            </form>
