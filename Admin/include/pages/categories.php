            ...
            <div class="modal-body">
                <form action="requests/category-management.php"  method="post" class="form-horizontal  col " >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <button type="submit" id="submit-category" name="submit-category" class="btn btn-general btn-blue mr-2">Submit</button>
                            <span></span>
                        </div>
                    </div>
                </form>
            ...
            <div class="modal-body">
                <form action="requests/subcategory-management.php"  method="post" class="form-horizontal  col " >
                    ...
                    <div class="form-group">
                        <label class="col-md-8 control-label text-left "></label>
                        <div class="col-md-8">
                            <button type="submit" id="submit-subcategory" name="submit-subcategory" class="btn btn-general btn-blue mr-2">Submit</button>
                            <span></span>
                        </div>
                    </div>
                </form>
        ...
        <div align="center" class="modal-content" style="margin-top: 100px">
            ...
            <div class="modal-footer">
                <div class="row" style="margin: auto;">
                    ...
                    <div class="col">
                        <button id="no-delete-subcategory" type="button" class="btn btn-info btn" data-dismiss="modal">No
                        </button>
                    </div>
                </div>
            </div>
                ...
                if ($result = mysqli_query($link, $query)) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <tr class="category-row" id="category-<?php echo $row['id']; ?>">
                            ...
                            <td class="">
                                <button data-id="<?php echo $row['id']; ?>" class="btn btn-danger btn delete-category"><i
                                            class="fa fa-trash-o  "
                ...
                if ($result = mysqli_query($link, $query2)) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <tr class="subcategory-row" id="subcategory-<?php echo $row['id']; ?>">
                            ...
                            <td class="">
                                <button data-id="<?php echo $row['id']; ?>" class="btn btn-danger btn delete-subcategory"><i
                                            class="fa fa-trash-o  "
                                            aria-hidden="true"></i></button>
                            </td>
                        </tr>
