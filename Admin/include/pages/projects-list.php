    ...
    <div class="row ">
        ...
        <table style="width: 100% " id="datatable" class="table table-hover mt-5 table-striped">
            ...
            <tr class="table-primary">
                ...
                <td class="text-left">Mhd Rami Khatib</td>
                <td class="text-left">0966859588</td>
                <td class="text-left">12/8/2019 2:07 PM</td>
                <td class="text-left text-danger">Pending</td>
                <td class="text-left"><a href="#" class="primary-color project-file">file.txt</a></td>
            </tr>
