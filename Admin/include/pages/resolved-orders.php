...
$sq = "'";
$path = '../';
$query = "select o.id, o.user_id, u.name, u.phone, o.status, o.date, o.total, o.note from orders o inner join user u on o.user_id = u.id where o.status = 3 || o.status=4 ";
