...
<div id="companies-form-modal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div align="center" class="modal-content" style="margin-top: 100px">
            ...
            <div class="modal-body">
                <form action="requests/companies-management.php" method="post" class="form-horizontal  col ">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <button type="submit" id="submit-companies" name="submit-companies"
...
<div id="confirm-modal-delete-companies" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <!-- Modal content-->
        <div align="center" class="modal-content" style="margin-top: 100px">
            <div class="modal-header">
            ...
            <div class="modal-footer">
                <div class="row" style="margin: auto;">
                    <div class="col">
                        <button id="yes-delete-companies" type="button" class="btn btn-info btn" data-dismiss="modal">
                            Yes
                        </button>
                    </div>
                    <div class="col">
                        <button id="no-delete-companies" type="button" class="btn btn-info btn" data-dismiss="modal">No
                        </button>
                    </div>
                </div>
            </div>
...
<div class="content-inner chart-cont">
    ...
    <div class="row">
        <div class="col-7"><h2 class="mb-5">Companies Listing</h2></div>
        <div class="col-5">
            <button id="add-companies" class="btn btn-info admin-add-btn">Add</i></button>
        </div>
    </div>
    ...
    <table style="width: 100% " id="datatable" class="table table-hover mt-5 table-striped">
        ...
        if ($result = mysqli_query($link, $query)) {
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                ?>
                <tr class="companies-row" id="companies-<?php echo $row['id']; ?>">
                    <td class=""><?php echo $row['id']; ?></td>
                    <td class=""><?php echo $row['name']; ?></td>
                    <td class=""><?php echo $row['business']; ?></td>
                    <td class=""><?php echo $row['phone']; ?></td>
                    <td class=""><?php echo $row['email']; ?></td>
                    <td class=""><?php echo $row['address']; ?></td>
                    <td class="d-flex justify-content-center">
                        <button data-id="<?php echo $row['id']; ?>" class="btn btn-blue btn delete-companies">
                            <i
                                    class="fa fa-trash-o  "
